# Finding the Root of a Function {#sec-roots}
...
## The Method of Bracketing and Bisection {#sec-bisection}
...
# Now this is fun. I want to replicate the parabola
# in the original text but I don't know the coefficients. 
# Instead of guessing the coefficients directly, I can eyeball
# A few of the points and the solve for the coefficients. 
# Three points uniquely defines a parabola! A little Ax=b
# and bingo-bango!
...
# I _could_ hard code the function and the derivative
# but I could also use Sympy to figure out the derivative
# for me! Much cooler!
...
# Iterate a few times to refine the root
for _ in range(10):
    xr = newton_step(xr)
